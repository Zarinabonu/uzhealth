...
from app.staff_views import IndexPage,  StaffDoctorListView, StaffDoctorDetailView, StaffDoctorUpdatePage, StaffOperatorListPage, TemplateListView, TemplateDetailView
